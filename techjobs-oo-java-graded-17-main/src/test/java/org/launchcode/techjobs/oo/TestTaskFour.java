...
public class TestTaskFour extends AbstractTest {
    ...
    // Test the Full Constructor using test called testJobConstructorSetsAllFields to generate two jobs
    // that have identical field values except for id
    @Test
    ...
    // Create test called "testsJobsForEquality"
    @Test
